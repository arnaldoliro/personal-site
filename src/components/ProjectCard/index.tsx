...
export default function ProjectCard({ imageSrc }: { imageSrc?: string }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative group mb-4 rounded-2xl overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center gap-4 transition-opacity duration-300">
          <a className="p-3 bg-custom-gradient rounded-xl shadow-lg hover:shadow-[#f97316] transition-all duration-500 cursor-pointer">
            Ver Projeto
          </a>
          <a className="p-3 bg-transparent border-2 border-[#f97316] text-[#f97316] font-semibold rounded-xl hover:bg-[#f97316] hover:text-gray-900 transition-all duration-400 cursor-pointer">
            Github
          </a>
        </div>
      </div>
      ...
      <div className="px-4 pb-4">
        <h3 className="text-2xl text-white font-semibold mb-4">Nome do Projeto</h3>
